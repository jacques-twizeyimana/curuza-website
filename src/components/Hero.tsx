      ...
      <div className="container-px">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="reveal mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-ink-600 text-balance">
            Curuza is the point-of-sale built for Rwanda. Sell, track stock, issue EBM
            invoices and know exactly when to register, file and pay your taxes — all from
            the same everyday records.
          </p>
          ...
          <div className="reveal mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-ink-500">
            <span className="inline-flex items-center gap-1.5">
              <CheckCircle2 className="h-4 w-4 text-forest-600" /> No internet needed
            </span>
            <span className="inline-flex items-center gap-1.5">
              <CheckCircle2 className="h-4 w-4 text-forest-600" /> Works in Kinyarwanda
            </span>
            <span className="inline-flex items-center gap-1.5">
              <CheckCircle2 className="h-4 w-4 text-forest-600" /> RRA-ready invoices
            </span>
          </div>
        </div>
        ...
        <div className="col-span-12 p-5 sm:col-span-9 sm:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="font-display text-lg font-700 text-ink-950">
                Good morning, Aline
              </h3>
            </div>
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            {[
              { label: 'Today', value: 'RWF 84,300', sub: '+12%', tone: 'forest' },
              { label: 'This week', value: 'RWF 612,000', sub: '+8%', tone: 'ink' },
              { label: 'Stock value', value: 'RWF 2.4M', sub: '−3%', tone: 'amber' },
            ].map((k) => (
              <div
                key={k.label}
          ...
          <div className="mt-4 grid grid-cols-12 gap-3">
            <div className="col-span-12 rounded-2xl border border-ink-100 bg-white p-4 sm:col-span-7">
              <p className="text-xs font-semibold text-ink-500">Sales this week</p>
            ...
            <div className="col-span-12 rounded-2xl border border-forest-200 bg-forest-50 p-4 sm:col-span-5">
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs font-semibold text-forest-800">Tax readiness</p>
              </div>
              <p className="mt-2 font-display text-3xl font-800 text-forest-800">92%</p>
